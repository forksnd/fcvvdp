...
/* Version */
static const char* CVVDP_VERSION = "0.4.0";
...
typedef enum FcvvdpDisplayModel {
    ...
    CVVDP_DISPLAY_STANDARD_HMD,
    CVVDP_DISPLAY_STANDARD_PHONE,
    CVVDP_DISPLAY_SDR_4K_30,
    CVVDP_DISPLAY_SDR_FHD_24,
    CVVDP_DISPLAY_HTC_VIVE_PRO,
    CVVDP_DISPLAY_IPHONE_12_PRO,
    CVVDP_DISPLAY_IPHONE_14_PRO,
    CVVDP_DISPLAY_IPHONE_14_PRO_VERT,
    CVVDP_DISPLAY_IPHONE_14_PRO_HDR,
    CVVDP_DISPLAY_IPHONE_14_PRO_HDR_VERT,
    CVVDP_DISPLAY_IPAD_PRO_12_9,
    CVVDP_DISPLAY_MACBOOK_PRO_16,
    CVVDP_DISPLAY_LG_OLED_2017_SDR,
    CVVDP_DISPLAY_LG_OLED_2017_HDR,
    CVVDP_DISPLAY_EIZO_CG3146,
    CVVDP_DISPLAY_65INCH_HDR_PQ_4KNIT,
    CVVDP_DISPLAY_65INCH_HDR_PQ_2KNIT,
    CVVDP_DISPLAY_65INCH_HDR_PQ_1KNIT,
    CVVDP_DISPLAY_LG_OLED_2026_HDR_PQ,
    CVVDP_DISPLAY_CID22_MCOS,
